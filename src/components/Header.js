    ...
    return (
        <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black dark:bg-black">
                ...
                {pageName !== "video" && (
                    ...
                    >
                        ...
                        {mobileMenu ? (
                            ...
                            <SlMenu className="text-orange-500 text-xl" />
                        )}
                    </div>
                )}
            ...
            <div className="flex items-center">
                ...
                <div className="flex  border border-white h-8 w-8 overflow-hidden rounded-full md:ml-4">
                    <img  alt="img" src="https://xsgames.co/randomusers/assets/avatars/female/67.jpg" />
                </div>
            </div>
        </div>
    );
